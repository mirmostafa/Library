...
namespace Mohammad.Win32.Natives
{
    ...
    {
        /// <summary>
        ///     The Run function attempts to log a user on to the local computer.
        ...
        ///     a token handle returned by a call to Run, CreateRestrictedToken, DuplicateToken, DuplicateTokenEx,
