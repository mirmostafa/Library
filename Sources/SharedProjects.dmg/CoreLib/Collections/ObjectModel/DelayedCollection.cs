...
namespace Mohammad.Collections.ObjectModel
{
    ...
    public class DelayedCollection<T> : ICollection<T>
    {
        ...
        /// </summary>
        /// <value></value>
        public T this[int index] { get { return this.BackingList[index]; } set { this.BackingList[index] = value; } }
        ...
        /// </returns>
        public int IndexOf(T item) { return this.BackingList.IndexOf(item); }
        ...
        /// </exception>
        public void Insert(int index, T item) { this.BackingList.Insert(index, item); }
        ...
        ///     The <see cref="T:System.Collections.Generic.IList`1" /> is read-only.
        /// </exception>
        public void RemoveAt(int index) { this.BackingList.RemoveAt(index); }
        ...
        /// </exception>
        public void Add(T item) { this.BackingList.Add(item); }
        ...
        ///     The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only.
        /// </exception>
        public void Clear() { this.BackingList.Clear(); }
        ...
        ///     otherwise, false.
        /// </returns>
        public bool Contains(T item) { return this.BackingList.Contains(item); }
        ...
        ///     -or-
        ///     Type <paramref /> cannot be cast automatically to the type of the destination <paramref name="array" />.
        /// </exception>
        public void CopyTo(T[] array, int arrayIndex) { this.BackingList.CopyTo(array, arrayIndex); }
        ...
        ///     The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only.
        /// </exception>
        public bool Remove(T item) { return this.BackingList.Remove(item); }
        ...
        /// </returns>
        IEnumerator IEnumerable.GetEnumerator() { return this.BackingList.GetEnumerator(); }
    }
}