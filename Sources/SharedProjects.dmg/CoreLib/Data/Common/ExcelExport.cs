...
namespace Mohammad.Data
{
    public class ExcelExport : Singleton<ExcelExport>
    {
        ...
        {
            return this.GetExcelXml(new[] {table});
        }
        ...
        {
            return this.GetExcelXml(tables.ToArray());
        }
        ...
        {
            return from DataTable table in tables
        ...
        {
            return from DataTable table in datatables
