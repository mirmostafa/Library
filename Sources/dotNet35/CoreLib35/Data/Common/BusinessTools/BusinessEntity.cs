...
namespace Library35.Data.Common.BusinessTools
{
		...
		where TEntity : class
	{
		...
		public abstract TEntity FillCore(TEntity entity);
		...
		public abstract TEntity GetNewCore();
		...
		private void OnFilled(EntityActed<TEntity> e)
		{
			this.Filled.Raise(this, e);
		}

		private void OnGotNew(EntityActed<TEntity> e)
		{
