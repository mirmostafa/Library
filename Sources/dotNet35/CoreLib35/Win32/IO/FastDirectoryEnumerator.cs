...
namespace Library35.Win32.IO
{
	...
	public static class FastDirectoryEnumerator
	{
		...
		/// <returns>
		///     An object that implements <see cref="IEnumerable{T}" /> and allows you to enumerate the files in the given
		///     directory.
		/// </returns>
		...
		/// <returns>
		///     An object that implements <see cref="IEnumerable{FileData}" /> and allows you to enumerate the files in the given
		///     directory.
		/// </returns>
		/// <exception cref="ArgumentNullException">
		///     <paramref name="path" />
		...
		///     One of the SearchOption values that specifies whether the search operation should include
		...
		private class FileEnumerator : IEnumerator<FileData>
		{
			...
			{
				get { return new FileData(this._Path, this._Win32FindData); }
			}
