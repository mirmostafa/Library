...
using Library35.Windows.Actions;
using Action = Library35.Windows.Actions.Action;
...
namespace Library35.Windows.Controls
{
	...
	public class ActionList : Component, IExtenderProvider, ISupportInitialize
	{
		...
		public Dictionary<Type, ActionTargetDescriptionInfo> TypesDescription { get; private set; }
		...
		{
			get { return this.getActiveControl(this.ContainerControl); }
		}
		...
		protected virtual Type[] GetSupportedTypes()
		{
			return new[]
			       {
				       typeof (ButtonBase), typeof (ToolStripButton), typeof (ToolStripMenuItem), typeof (ToolBarButton), typeof (MenuItem)
			       };
		}
