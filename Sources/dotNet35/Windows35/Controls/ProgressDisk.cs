...
namespace Library35.Windows.Controls
{
	...
	public partial class ProgressDisk : UserControl
	{
		...
		{
			get { return this._SliceCount; }
			set { this._SliceCount = value; }
		}
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			e.Graphics.FillPath(new LinearGradientBrush(new Rectangle(0, 0, this.size, this.size), this.inactiveForeColor1, this.inactiveForeColor2, this._Value * 360 / 12, true),
				this._ValuePath);
			e.Graphics.FillPath(new LinearGradientBrush(new Rectangle(0, 0, this.size, this.size), this.activeForeColor1, this.activeForeColor2, this._Value * 360 / 12, true),
				this._FreGroundPath);
		...
		private void Render()
		{
			...
			//just in case...
			if (this._SliceCount == 0)
				this._SliceCount = 12;

			float sliceAngle = 360 / this._SliceCount;
