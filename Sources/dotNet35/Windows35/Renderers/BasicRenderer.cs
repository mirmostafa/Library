...
namespace Library35.Windows.Renderers
{
		...
		where TBasicRenderer : BasicRenderer<TBasicRenderer>, new()
	{
		...
		protected virtual Color BackgroundGradientEndColor
		{
			get { return SystemColors.ControlDark; }
		}

		protected virtual Color BackgroundGradientStartColor
		{
			get { return SystemColors.ControlDark; }
		}
		...
		protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
		{
			...
			if (this.backgroundBrush == null)
				this.backgroundBrush = new LinearGradientBrush(e.ToolStrip.ClientRectangle, this.BackgroundGradientStartColor, this.BackgroundGradientEndColor, 90f, true);
