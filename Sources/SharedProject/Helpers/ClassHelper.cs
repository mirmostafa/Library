...
namespace Mohammad.Helpers
{
    ...
    public static class ClassHelper
    {
        ...
        public static string GetClassName(this MethodBase method) => method?.DeclaringType?.Name;

        public static TAttribute GetDeclaringTypeAttribute<TAttribute>(this MethodBase method, TAttribute defaultValue = null)
        ...
        public static string GetDescription(object classInstance) => GetDescription(classInstance, "");
