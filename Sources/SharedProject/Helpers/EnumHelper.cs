...
namespace Mohammad.Helpers
{
    ...
    public static class EnumHelper
    {
        ...
        public static TEnum Convert<TEnum>(object value)
            where TEnum : struct => Convert<object, TEnum>(value);
        ...
        /// <typeparam name="TEnum"></typeparam>
        /// <returns></returns>
        public static IEnumerable<MemberInfo<TEnum>> GetMembers<TEnum>(bool localized = false)
            where TEnum : struct
        {
        ...
        /// <returns></returns>
        public static IEnumerable<TNumberType> GetValues<TEnum, TNumberType>()
            where TEnum : struct
        {
        ...
        public static bool IsEnumInRange<TEnum>(TEnum value, params TEnum[] range)
            where TEnum : struct => range.Contains(value);
