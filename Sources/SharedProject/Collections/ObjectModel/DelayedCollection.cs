...
namespace Mohammad.Collections.ObjectModel
{
    ...
    public class DelayedCollection<T> : ICollection<T>
    {
        ...
        ///     otherwise, false.
        /// </returns>
        public bool Contains(T item) => this.BackingList.Contains(item);
        ...
        ///     The <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only.
        /// </exception>
        public bool Remove(T item) => this.BackingList.Remove(item);
        ...
        /// </returns>
        public IEnumerator<T> GetEnumerator() => this.BackingList.GetEnumerator();
        ...
        /// </returns>
        IEnumerator IEnumerable.GetEnumerator() => this.BackingList.GetEnumerator();
        ...
        /// </returns>
        public int IndexOf(T item) => this.BackingList.IndexOf(item);
