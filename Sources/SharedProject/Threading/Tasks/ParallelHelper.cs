...
namespace Mohammad.Threading.Tasks
{
    public static class ParallelHelper
    {
        ...
        /// <returns></returns>
        public static List<TResult> ForEachTask<T, TResult>(this IEnumerable<T> source, Func<T, TResult> function) => ForEachAsync(source, function).Result;

        public static void ForEachTask<T>(this IEnumerable<T> source, Action<T> function)
        {
            ForEachAsync(source, function).Wait();
        }
        ...
        public static IEnumerable<TResult> FastForEachLazy<T, TResult>(this IEnumerable<T> source, Func<T, TResult> action) =>
