...
namespace Mohammad.Globalization
{
    public static class GlobalizationUtilities
    {
        ...
        public static IEnumerable<string> GetPersianDayNames(string cultureName) => EnumHelper.GetDescriptions(EnumHelper.GetItems<PersianDayOfWeek>(), cultureName);
        ...
        public static IEnumerable<string> GetPersianAbbreviatedMonthNames()
            => new[] {"Far", "Ord", "Kho", "Tir", "Mor", "Shah", "Meh", "Aba", "Aza", "Dey", "Bah", "Esf", ""}.AsEnumerable();
        ...
        public static IEnumerable<string> GetGregorianAbbreviatedMonthGenitiveNames() => GregorianDateTimeFormatInfo.AbbreviatedMonthGenitiveNames.AsEnumerable();
