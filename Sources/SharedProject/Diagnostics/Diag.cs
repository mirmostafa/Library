...
namespace Mohammad.Diagnostics
{
    public static class Diag
    {
        ...
        public static MethodBase ScrollupTo(Type type)
        {
            return ScrollupTo(t => t == type);
        }
        ...
        {
            RedirectDebugsToListeren<DefaultTraceListener>(redirect);
        }

        public static void RedirectDebugsToConsole(bool redirect)
        {
            RedirectDebugsToListeren(redirect ? new TextWriterTraceListener(Console.Out) : null, redirect);
        }

        public static void RedirectDebugsToListeren<TListenerType>(bool redirect)
            where TListenerType : TraceListener, new()
        {
            RedirectDebugsToListeren(redirect ? new TListenerType() : null, redirect);
        }

        public static void RedirectDebugsToListeren<TListenerType>(TListenerType listener, bool redirect)
            where TListenerType : TraceListener
        {
            if (redirect)
            {
