...
// Created by Mohammad on 2017/10/17
// Last updated by Mohammad Mir mostafa on 2017/10/17
...
namespace Mohammad.Win.Helpers
{
    public static class ImageHelper
    {
        ...
        public static Rectangle GetBounds(this Image image) => new Rectangle(0, 0, image.Width, image.Height);

        public static Rectangle Surround(this Point p, int distance) => new Rectangle(p.X - distance,
            p.Y - distance,
            distance * 2,
            distance * 2);
    }
