...
namespace Mohammad.Win.Controls
{
    ...
    public partial class OutlookBar : UserControl
    {
        ...
        private void OutlookBar_Load(object sender, EventArgs e)
        {
            ...
            this.SetStyle(
                ControlStyles.AllPaintingInWmPaint | ControlStyles.ResizeRedraw | ControlStyles.DoubleBuffer | ControlStyles.Selectable | ControlStyles.UserMouse,
                true);
        }
    ...
    public class OutlookBarButton // : IComponent
    {
        ...
        [Description("The image that will be displayed on the button")]
        [Category("Data")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public Image Image
        {
