...
namespace Mohammad.Win.Internals
{
    ...
    public class Tab : ToolStripButton
    {
        ...
        /// </summary>
        [DefaultValue(true)]
        public new bool CheckOnClick { get { return base.CheckOnClick; } set { base.CheckOnClick = value; } }

        /// <summary>
        ///     Specify the default display style to be ImageAndText
        /// </summary>
        protected override ToolStripItemDisplayStyle DefaultDisplayStyle { get { return ToolStripItemDisplayStyle.ImageAndText; } }

        /// <summary>
        ///     Add extra internal spacing so we have enough room for our curve.
        /// </summary>
        protected override Padding DefaultPadding { get { return new Padding(35, 0, 6, 0); } }
        ...
        /// </summary>
        public Tab() { this.Initialize(); }

        public Tab(string text)
            : base(text, null, null) { this.Initialize(); }

        public Tab(Image image)
            : base(null, image, null) { this.Initialize(); }

        public Tab(string text, Image image)
            : base(text, image, null) { this.Initialize(); }

        public Tab(string text, Image image, EventHandler onClick)
            : base(text, image, onClick) { this.Initialize(); }

        public Tab(string text, Image image, EventHandler onClick, string name)
            : base(text, image, onClick, name) { this.Initialize(); }
