...
namespace Mohammad.Win.Internals
{
    ...
    public class Tab : ToolStripButton
    {
        ...
        /// </summary>
        protected override ToolStripItemDisplayStyle DefaultDisplayStyle => ToolStripItemDisplayStyle.ImageAndText;

        /// <summary>
        ///     Add extra internal spacing so we have enough room for our curve.
        /// </summary>
        protected override Padding DefaultPadding => new Padding(35, 0, 6, 0);
