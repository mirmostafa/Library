...
namespace Mohammad.Win.Renderers
{
    ...
    public class AquaRenderer : ToolStripProfessionalRenderer
    {
        ...
        static AquaRenderer()
        {
            ...
            m_statusStripBlend.Positions = new[] {0.0F, 0.2F, 0.3F, 0.4F, 0.8F, 1.0F};
            m_statusStripBlend.Factors = new[] {0.3F, 0.4F, 0.5F, 1.0F, 0.8F, 0.7F};
        }
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            if (toolStrip is StatusStrip)
            {
                ...
                if (backRectangle.Width > 0 && backRectangle.Height > 0)
                {
                    ...
                    using (
                            var innerRectangleBrush = new LinearGradientBrush(innerRectangle,
