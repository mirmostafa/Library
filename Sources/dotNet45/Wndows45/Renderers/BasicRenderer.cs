...
namespace Mohammad.Win.Renderers
{
        ...
        where TBasicRenderer : BasicRenderer<TBasicRenderer>, new()
    {
        ...
        protected virtual Color BackgroundGradientEndColor => SystemColors.ControlDark;
        protected virtual Color BackgroundGradientStartColor => SystemColors.ControlDark;
        protected virtual Color FontColor => SystemColors.ControlText;
