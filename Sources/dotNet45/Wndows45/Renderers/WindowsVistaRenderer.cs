...
namespace Mohammad.Win.Renderers
{
    ...
    public class WindowsVistaRenderer : ToolStripRenderer
    {
        ...
        protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
        {
            ...
            using (
                var b = new LinearGradientBrush(new Point(0, glow.Top - 1),
                    new PointF(0, glow.Bottom),
        ...
        private void DrawGlossyEffect(Graphics g, ToolStrip t, int offset)
        {
            ...
            using (
                var b = new LinearGradientBrush(glossyRect.Location,
                    new PointF(0, glossyRect.Bottom),
        ...
        private void DrawVistaButtonBackground(Graphics g, Rectangle r, bool selected, bool pressed, bool checkd)
        {
            ...
            fill.Height /= 2;
            var glow = Rectangle.FromLTRB(outerBorder.Left,
            ...
            using (
                Brush b = new LinearGradientBrush(new Point(0, glossy.Top),
        ...
        private void DrawVistaMenuBackground(Graphics g, Rectangle r, bool highlighted)
        {
            ...
            if (highlighted)
                ...
                {
                    using (
                        Brush b = new LinearGradientBrush(new Point(0, 2),
