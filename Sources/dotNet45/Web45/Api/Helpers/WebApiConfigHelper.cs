...
namespace Mohammad.Helpers
{
    public static class WebApiConfigHelper
    {
                                      ...
                                      Action<ExceptionLoggerContext>    onLoggingException  = null)
        {
            ...
            if (onHandlingException != null) config.Filters.Add(new ApiHandleExceptionsAttribute(onHandlingException));
            if (onLoggingException  != null) config.Services.Add(typeof(IExceptionLogger), new ApiExceptionLogger(onLoggingException));
        }
    }
}