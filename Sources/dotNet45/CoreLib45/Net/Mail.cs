...
namespace Mohammad.Net
{
    public class Mail
    {
        ...
        public Mail(string host, int? port, string userName, string password, string sender, string reciever = null,
                    string subject = null,
                    string content = null, string senderName = null, string domain = null, bool enableSsl = true, bool isBodyHtml = true)
        {
            this.Sender     = sender;
