...
namespace Mohammad.Net
{
    public class IisTools
    {
        ...
        private static string GetSystem32Dir() => $@"{Environment.GetEnvironmentVariable("WINDIR")}\System32";
        ...
        public static bool IisWebSupport() => File.Exists($@"{GetSystem32Dir()}\IIsWeb.vbs");
