...
namespace Mohammad.Helpers
{
    ...
    public static class NumericHelper
    {
        ...
        public static string ToCommaSeparate(this double num) => double.Parse(num.ToString(CultureInfo.InvariantCulture)).ToString("N",
        ...
        public static string ToCommaSeparate(this long num) => long.Parse(num.ToString(CultureInfo.InvariantCulture)).ToString("N",
                                                                                                                               new NumberFormatInfo
                                                                                                                               {
                                                                                                                                   NumberDecimalDigits = 0
                                                                                                                               });

        public static string ToCommaSeparate(this int num) => int.Parse(num.ToString(CultureInfo.InvariantCulture)).ToString("N",
                                                                                                                             new NumberFormatInfo
                                                                                                                             {
                                                                                                                                 NumberDecimalDigits = 0
                                                                                                                             });
