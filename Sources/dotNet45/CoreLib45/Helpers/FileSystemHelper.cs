...
namespace Mohammad.Helpers
{
    public static class FileSystemHelper
    {
        ...
        {
            file.MoveTo(Path.ChangeExtension(file.FullName, ext));
            return file;
        }
        ...
        public static DirectoryInfo CreateDirectory(this DirectoryInfo dir)
        {
            //if (!dir.Exists)
            dir.Create();
            return dir;
        ...
        public static DirectoryInfo CreateDirectory(string path) => GetDirectory(path).CreateDirectory();

        public static FileInfo CreateFile(this DirectoryInfo dir, string file)
        {
        ...
        public static DirectoryInfo DeleteFiles(this DirectoryInfo dir, string pattern = null)
        {
            GetFiles(dir.FullName, pattern ?? "*.*").ForEach(File.Delete);
            return dir;
        }
        ...
        /// <returns></returns>
        public static IEnumerable<string> GetAllDirectories(string path) => new DirectoryInfo(path).GetAllDirectories();
        ...
        /// <param name="path">The path.</param>
        /// <returns></returns>
        public static IEnumerable<string> GetAllFileSystems(string path) => new DirectoryInfo(path).GetAllFileSystems();
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSystem32Dir() => $@"{Environment.GetEnvironmentVariable("WINDIR")}\System32";
        ...
        public static (string Text, FileInfo File) Read(this FileInfo file) => (File.ReadAllText(file.FullName), file);

        public static FileInfo Read(this FileInfo file, out string text)
        {
        ...
        public static FileInfo Write(this FileInfo file, params string[] lines)
        {
            File.WriteAllLines(file.FullName, lines);
            return file;
        }

        public static FileInfo Write(this FileInfo file, IEnumerable<string> lines)
        {
            File.WriteAllLines(file.FullName, lines);
            return file;
        }
        ...
        public static FileInfo AppendLine(this FileInfo file)
        {
