...
namespace Mohammad.Helpers
{
    ...
    public static class ComparableHelper
    {
        ...
        public static bool IsGreaterThan<T>(this T left, T right)
        ...
        /// <param name="right">The right.</param>
        /// <returns>true if left &gt;= right</returns>
        public static bool IsGreaterThanOrEqual<T>(this T left, T right)
            where T : class, IComparable<T>
        {
            if (left == null)
        ...
        /// <param name="right">The right.</param>
        /// <returns>true if left &lt; right </returns>
        public static bool IsLessThan<T>(this T left, T right)
            where T : class, IComparable<T>
        {
            if (left == null)
                return right != null;
        ...
        public static bool IsLessThanOrEqual<T>(this T left, T right)
            where T : class, IComparable<T>
        {
            if (left == null)
                return true;
