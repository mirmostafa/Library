...
namespace Mohammad.Validation
{
    ...
    {
        public static void Validate<TException>(Func<bool> isValid, string message, Action onIsValid, Func<TException, bool> onIsNotValid, object owner)
        ...
        public static void Validate<TException>(Func<bool> isValid, string message, Action onIsValid, Func<TException, bool> onIsNotValid)
            where TException : ExceptionBase
        {
            Validate(isValid, message, onIsValid, onIsNotValid, null);
        }

        public static void Validate<TException>(Func<bool> isValid, string message, Func<TException, bool> onIsNotValid)
            where TException : ExceptionBase
        {
            Validate(isValid, message, null, onIsNotValid, null);
        }

        public static void Validate<TException>(Func<bool> isValid, Func<TException, bool> onIsNotValid)
            where TException : ExceptionBase
        {
            Validate(isValid, null, null, onIsNotValid, null);
        }

        public static void Validate<TException>(Func<bool> isValid, string message, Action onIsValid, Action<TException> onIsNotValid, object owner)
            where TException : ExceptionBase
        {
        ...
        public static void Validate(Func<bool> isValid, string message, Action onIsValid, Func<Exception, bool> onIsNotValid)
        {
            Validate<ValidationException>(isValid, message, onIsValid, onIsNotValid, null);
        }

        public static void Validate(Func<bool> isValid, Action onIsValid, Func<Exception, bool> onIsNotValid)
        {
            Validate<ValidationException>(isValid, null, onIsValid, onIsNotValid, null);
        }

        public static void Validate(Func<bool> isValid, Func<Exception, bool> onIsNotValid)
        {
        ...
        public static IEnumerable<string> FindNullsOrEmpties(this IEnumerable<string> items) => items.Where(i => i.IsNullOrEmpty()).Select(i => i);
        ...
        ///     The invalid items according to the specific item.
        /// </returns>
        public static IEnumerable<(object data, string name)> FindInvalids(this IEnumerable<(object data, string name)> items, Func<object, bool> isValid) =>
            items.Where(i => !isValid(i.data)).Select(i => i);
