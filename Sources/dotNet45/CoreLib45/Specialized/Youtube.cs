...
namespace Mohammad.Specialized
{
    ...
    public class YoutubeVideoFormat : INotifyPropertyChanged
    {
        ...
        private static string GetResolution(string itag)
        {
            switch (itag)
            {
                ...
                case "82": return "360p(3D)";

                case "83": return "240p(3D)";

                case "84": return "720p(3D)";

                case "85": return "520p(3D)";

                case "100": return "360p(3D)";

                case "101": return "360p(3D)";

                case "102": return "720p(3D)";

                case "120": return "720p";

                case "133": return "240p";

                case "134": return "360p";

                case "135": return "480p";
                ...
                case "141": return "High";

                case "160": return "144p";
            }
    ...
    public class YoutubeDownloader : LoggerContainer, INotifyPropertyChanged, IDisposable
    {
        ...
        public void Start()
        {
            this.Start(Environment.CurrentDirectory);
        }
