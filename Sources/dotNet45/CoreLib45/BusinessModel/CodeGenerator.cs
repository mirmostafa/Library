...
namespace Mohammad.BusinessModel
{
    public class CodeGenerator
    {
        ...
        public string GetDataEntity(IEnumerable<string> tablenames = null,
            bool createModelClass = true,
            string modelClassName = null,
            string modelBaseClassName = null,
            string entitiesBaseClassName = null,
            string ns = null,
        ...
        public string GetBusinessEntity(string ns,
            IEnumerable<string> tablenames = null,
            bool perTable = true,
            string className = null,
            string classesPrefix = "Entity",
