...
namespace Mohammad.BusinessModel
{
    public class CodeGenerator
    {
        ...
        public string GetDataEntity(IEnumerable<string> tablenames         = null, bool   createModelClass      = true, string modelClassName = null,
                                    string              modelBaseClassName = null, string entitiesBaseClassName = null, string ns             = null,
        ...
        public string GetBusinessEntity(string              ns,                            IEnumerable<string> tablenames = null,
                                        bool                perTable           = true,     string              className  = null,
                                        string              classesPrefix      = "Entity", string              baseClass  = null,
                                        bool                isBaseClassGeneric = true,
                                        bool                addDmlStatements   = false,
                                        IEnumerable<string> usings             = null)
        {
            var tables        = this.GetTables(tablenames).ToList();
            var codeNamespace = new CodeNamespace(ns);
