...
namespace Mohammad.Win32.NetworkList
{
    ...
    public class Network
    {
        ...
        {
            get => this.network.GetCategory();
            set => this.network.SetCategory(value);
        }
        ...
        /// </value>
        public NetworkConnectionCollection Connections => new NetworkConnectionCollection(this.network.GetNetworkConnections());
        ...
        /// </remarks>
        public Connectivity Connectivity => this.network.GetConnectivity();
        ...
        {
            get => this.network.GetDescription();
            set => this.network.SetDescription(value);
        }
        ...
        /// </remarks>
        public DomainType DomainType => this.network.GetDomainType();
        ...
        /// </value>
        public bool IsConnected => this.network.IsConnected;
        ...
        ///     A <see cref="System.Boolean" /> value.
        /// </value>
        public bool IsConnectedToInternet => this.network.IsConnectedToInternet;
        ...
        public string Name
        {
            get => this.network.GetName();
            set => this.network.SetName(value);
        }
