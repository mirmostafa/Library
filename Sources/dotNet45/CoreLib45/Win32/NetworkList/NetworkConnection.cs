...
namespace Mohammad.Win32.NetworkList
{
    ...
    public class NetworkConnection
    {
        ...
        /// </returns>
        public Network Network => new Network(this.networkConnection.GetNetwork());
        ...
        /// </value>
        public Guid AdapterId => this.networkConnection.GetAdapterId();
        ...
        ///     A <see cref="System.Guid" /> object.
        /// </value>
        public Guid ConnectionId => this.networkConnection.GetConnectionId();
        ...
        /// </value>
        public Connectivity Connectivity => this.networkConnection.GetConnectivity();
        ...
        /// </value>
        public DomainType DomainType => this.networkConnection.GetDomainType();
        ...
        /// </value>
        public bool IsConnectedToInternet => this.networkConnection.IsConnectedToInternet;
