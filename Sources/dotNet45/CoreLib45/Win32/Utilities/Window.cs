...
namespace Mohammad.Win32.Utilities
{
    ...
    public class Window : IEquatable<Window>
    {
            ...
            set
            {
                switch (value)
                {
                    ...
                    case WindowState.Minimize:
                        ...
                        break;
                    case WindowState.Maximize: break;
        ...
        public string Text
        {
            get => GetWindowText(this.Hwnd);
            set => Api.SetWindowText(this.Hwnd, value);
        }

        public Window Parent => new Window(Api.GetParent(this.Hwnd));

        public bool Enabled
        {
            get => Api.IsWindowEnabled(this.Hwnd);
        ...
        public bool Visible
        {
            get => Api.IsWindowVisible(this.Hwnd);
        ...
        private sealed class HwndEqualityComparer : IEqualityComparer<Window>
        {
            ...
            public int GetHashCode(Window obj) => obj.Hwnd.GetHashCode();
        }
    }
