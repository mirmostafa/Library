...
namespace Mohammad.Win32.Natives.IfacesEnumsStructsClasses
{
    ...
    public sealed class WindowsHookUtil
    {
        ...
        public class KBDLLHOOKSTRUCT
        {
            ...
            [MarshalAs(UnmanagedType.I4)] public int scanCode;

            [MarshalAs(UnmanagedType.I4)] public int time;

            [MarshalAs(UnmanagedType.I4)] public int vkCode;
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public uint dwcbSize;

        [MarshalAs(UnmanagedType.U4)] public uint dwFlags;

        public IntPtr hwndParent;

        [MarshalAs(UnmanagedType.LPStr)] public string pcszVerb;
    }
    ...
    public struct URLINVOKECOMMANDINFOW
    {
        ...
        [MarshalAs(UnmanagedType.LPWStr)] public string pcszVerb;
    }
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public uint dwFileAttributes;
    ...
    {
        [MarshalAs(UnmanagedType.U4)] public uint tdSize;
    ...
    {
        [MarshalAs(UnmanagedType.I4)] public int cx;

        [MarshalAs(UnmanagedType.I4)] public int cy;
    ...
    public struct DOCHOSTUIINFO
    {
        ...
        [MarshalAs(UnmanagedType.LPWStr)] public string pchHostNS;
    }
    ...
    public struct tagOLEVERB
    {
        ...
        [MarshalAs(UnmanagedType.U4)] public uint fuFlags;

        [MarshalAs(UnmanagedType.U4)] public uint grfAttribs;
    }
    ...
    public struct tagOIFI
    {
        ...
        [MarshalAs(UnmanagedType.Bool)] public bool fMDIApp;

        public IntPtr hwndFrame;
        public IntPtr hAccel;

        [MarshalAs(UnmanagedType.U4)] public uint cAccelEntries;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct STGMEDIUM
    {
        [MarshalAs(UnmanagedType.U4)] public int tymed;
    ...
    public struct RECT : IEquatable<RECT>
    {
        ...
        public int Height
        {
            get => this.Bottom - this.Y;
            set => this.Bottom = value - this.Y;
        }

        public int Width
        {
            get => this.Right - this.X;
            set => this.Right = value + this.X;
        }
        ...
        public static implicit operator RECT(Rectangle rectangle) => new RECT(rectangle);
