...
namespace Mohammad.Win32.Natives
{
    public partial class Api
    {
        ...
        public static extern bool CreateProcessAsUser(IntPtr                  hToken, string lpApplicationName,
                                                      ...
                                                      IntPtr                  lpEnvironment,       int                     lpCurrentDirectory,
        ...
        public static extern bool CreateProcessAsUser(IntPtr                  hToken, string lpApplicationName,
                                                      ...
                                                      IntPtr                  lpEnvrionment,       string                  lpCurrentDirectory,
                                                      ref STARTUPINFO         lpStartupInfo,
                                                      ref PROCESS_INFORMATION lpProcessInformation);

        [DllImport("advapi32.dll", EntryPoint = "DuplicateTokenEx")]
        public static extern bool DuplicateTokenEx(IntPtr hExistingToken,     int dwDesiredAccess, ref SECURITY_ATTRIBUTES lpThreadAttributes,
