...
namespace Mohammad.Win32.IO
{
    ...
    public static class FastDirectoryEnumerator
    {
        ...
        private class FileEnumerable : IEnumerable<FileData>
        {
            ...
            /// </returns>
            public IEnumerator<FileData> GetEnumerator() => new FileEnumerator(this._Path, this._Filter, this._SearchOption);
            ...
            /// </returns>
            IEnumerator IEnumerable.GetEnumerator() => new FileEnumerator(this._Path, this._Filter, this._SearchOption);
        }
