...
namespace Mohammad.Logging
{
    public class Logger : ILogger
    {
        ...
        {
            get => this._LogTextFormat.IsNullOrEmpty() ? DEFAULT_LOG_TEXT_FORMAT : this._LogTextFormat;
            set => this._LogTextFormat = value;
        }

        public string MoreInfoTextFormat
        {
            get => this._MoreInfoTextFormat.IsNullOrEmpty() ? "-------------------[%moreinfo%]" : this._MoreInfoTextFormat;
        ...
        public void Info(object                    text, object moreInfo = null, object sender = null,
        ...
        public void Warn(object                    text, object moreInfo = null, object sender = null,
                         [CallerMemberName] string memberName     = "",
                         [CallerFilePath]   string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        {
        ...
        public void Exception(object                    text, Exception ex = null, object sender = null,
                              [CallerMemberName] string memberName     = "",
                              [CallerFilePath]   string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        {
        ...
        public void Fatal(object                    text, Exception ex = null, object sender = null,
                          [CallerMemberName] string memberName     = "",
                          [CallerFilePath]   string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        {
        ...
        public void Debug(object text, Exception ex = null, object sender = null, string memberName = "", string sourceFilePath = "",
        ...
        public void Log(object                    text,                    object                  moreInfo       = null,
                        ...
                        [CallerLineNumber] int    sourceLineNumber = 0)
        {
            ...
            if (this.EnableRaisingEvents)
                this.OnLogging(new LogEventArgs(text, moreInfo, level)
                {
            ...
            if (this.EnableRaisingEvents)
                this.OnLogged(new LogEventArgs(text, moreInfo, level)
                {
                    Sender = sender
                });
        }
                                           ...
                                           string logTextFormat = DEFAULT_LOG_TEXT_FORMAT)
        {
            ...
            Func<string, string, string> replace =
                (format, value) => value.IsNullOrEmpty() ? logText.Remove($"[%{format}%]") : logText.Replace($"%{format}%", value);
