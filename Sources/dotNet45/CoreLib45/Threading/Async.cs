...
namespace Mohammad.Threading
{
    ...
    public abstract class Async : IEquatable<Async>, IExceptionHandlerContainer, IDisposable
    {
        ...
        public List<object> Parameteres { get; }
        ...
        {
            get => this._ExceptionHandling.Value;
        ...
        public static Async GetAsyncInstance<T>(Action<T> method, T arg1, string name = null, AsyncPool pool = null, object group = null,
                                                object    tag = null) =>
            GetAsyncInstance(method, EnumerableHelper.AsEnuemrable(arg1), name, pool, group, tag);
        ...
        public static Async GetAsyncInstance(Action method, string name = null, AsyncPool pool = null, object group = null, object tag = null) =>
            GetAsyncInstance(method, null, name, pool, group, tag);
        ...
        public static Async Run<T1, T2>(Action<T1, T2> method, T1 arg1, T2 arg2, string name = null, AsyncPool pool = null, object group = null,
                                        object         tag = null) => Run(method, EnumerableHelper.AsEnuemrable(arg1, arg2), name, pool, group, tag);

        public static Async Run<T1>(Action<T1> method, T1 arg1, string name = null, AsyncPool pool = null, object group = null, object tag = null) => Run(
            method,
            EnumerableHelper.AsEnuemrable(arg1),
            name,
            pool,
            group,
            tag);

        public static Async Run(Action method, string name = null, AsyncPool pool = null, object group = null, object tag = null) => Run(method,
                                                                                                                                         null,
                                                                                                                                         name,
                                                                                                                                         pool,
                                                                                                                                         group,
        ...
        public static Async Run(Delegate methodInfo, IEnumerable args = null, string name = null, AsyncPool pool = null, object group = null,
                                object   tag = null)
        {
        ...
        public static bool MustStopIt() => !EnumHelper.IsEnumInRange(Thread.CurrentThread.ThreadState, ThreadState.Running, ThreadState.Background);
