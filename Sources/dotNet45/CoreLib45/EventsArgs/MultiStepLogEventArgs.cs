...
namespace Mohammad.EventsArgs
{
    ...
    {
        public MultiStepStartedLogEventArgs(double maxSteps, object log = null, object moreInfo = null, LogLevel level = LogLevel.Info,
    ...
    {
        public MultiStepLogEventArgs(double step, object log = null, object moreInfo = null, object sender = null, LogLevel level = LogLevel.Info,
                                     double max = -1)
            : base(log, moreInfo, level)
        {
            this.Step   = step;
