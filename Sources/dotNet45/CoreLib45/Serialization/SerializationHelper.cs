...
namespace Mohammad.Serialization
{
    public static class SerializationHelper
    {
        ...
        /// <returns></returns>
        public static TClass Load<TClass>(string xmlFilePath, TClass defaultValue, bool isEncrypted = false, string password = null)
            where TClass : class
        {
        ...
        public static TClass Load<TClass>(string xmlFilePath, bool isEncrypted = false, string password = null) => Deserialize<TClass>(xmlFilePath,
            isEncrypted,
            password);
