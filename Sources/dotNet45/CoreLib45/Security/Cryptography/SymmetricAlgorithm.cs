...
namespace Mohammad.Security.Cryptography
{
    ...
    public class SymmetricAlgorithm : IBidirectionalCryptographicAlgorithm
    {
        ...
        public string Encrypt(string expression) => this.DoSymmetric(expression, true);
        ...
        public string Decrypt(string encryptedExpression) => this.DoSymmetric(encryptedExpression, false);
