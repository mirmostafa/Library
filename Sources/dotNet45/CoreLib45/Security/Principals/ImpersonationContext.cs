...
namespace Mohammad.Security.Principals
{
    public class ImpersonationContext
    {
        ...
        private static extern bool LogonUser(string     lpszUsername, string lpszDomain, string lpszPassword, int dwLogonType, int dwLogonProvider,
                                             ref IntPtr phToken);
        ...
        public void Enter()
        {
            ...
            var logonSuccessfull = LogonUser(this._Username,
                                             this._Domain,
                                             this._Password,
