...
namespace Mohammad.Primitives
{
        ...
        where TApp : class, ISingleton<TApp>
    {
        ...
        {
            get => this._ApplicationLogSender ?? this.AppName;
        ...
        //{
        //    this.Logger.Log(text, details, sender ?? this.DefaultLogSender, level, memberName, sourceFilePath, sourceLineNumber);
        //}
        ...
        //{
        //    this.Logger.Debug(text, details, sender ?? this.DefaultLogSender, memberName, sourceFilePath, sourceLineNumber);
        //}

        //protected void Info(object text, object details = null, object sender = null, [CallerMemberName] string memberName = "",
        //    [CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        //{
        //    this.Logger.Info(text, details, sender ?? this.DefaultLogSender, memberName, sourceFilePath, sourceLineNumber);
        //}

        //protected void Warn(object text, object details = null, object sender = null, [CallerMemberName] string memberName = "",
        //    [CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
        //{
        //    this.Logger.Warn(text, details, sender ?? this.DefaultLogSender, memberName, sourceFilePath, sourceLineNumber);
        //}
