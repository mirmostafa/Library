...
namespace Mohammad.Data.SqlServer
{
    ...
    {
        public static string Build(string dataSource, string userId = null, string password = null,
                                   string initialCatalog     = null,
                                   bool?  integratedSecurity = null, bool? persistSecurityInfo = null, int? connectTimeout = 30,
                                   string attachDbFilename   = null,
                                   string applicationName    = null, bool? multipleActiveResultSets = null, bool? encrypt = null, bool? userInstance = null)
        {
