...
namespace Mohammad.Data.SqlServer.Dynamics
{
    public class Table : SqlObject<Table, Database>, IEnumerable
    {
        ...
        public IEnumerable<string> PrintFormatted(CancellationTokenSource cancellation = null, string columnsSeparator = "\t", string cellsSeparator = "\t",
                                                  params string[]         columns)
        {
            ...
            foreach (var column in columns)
            {
                ...
                foreach (DataRow row in table.Rows)
                {
                    ...
                    if (length > max) max = length.Value;
