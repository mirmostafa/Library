...
namespace Mohammad.Runtime.Proxies
{
        ...
        where T : MarshalByRefObject
    {
        ...
        public static T Create(T                                        instance, Action<InvokeEventArgs> onInvoked = null,
                               Action<InvokeEventArgs>                  onInvoking          = null,
        ...
        public class InvokeEventArgs : EventArgs
        {
            ...
            public static InvokeEventArgs Create(T instance, IMethodCallMessage msg) => new InvokeEventArgs(instance,
                                                                                                            ...
                                                                                                            msg.MethodName,
                                                                                                            EnumerableHelper.For(
                                                                                                                msg.ArgCount,
                                                                                                                index => (msg.GetArgName(index),
                                                                                                                          msg.GetArg(index))));
        }
    }
}