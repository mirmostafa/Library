...
namespace Mohammad.Wpf.Windows.Controls
{
	...
	public partial class HeaderedPanel
	{
		...
		[Bindable(true)]
		public object Header { get => this.GetValue(HeaderProperty); set => this.SetValue(HeaderProperty, value); }
		...
		[Bindable(true)]
		public bool IsChildEnabled { get => (bool) this.GetValue(IsChildEnabledProperty); set => this.SetValue(IsChildEnabledProperty, value); }
		...
		public Brush SepratorColor { get => (Brush) this.GetValue(SepratorColorProperty); set => this.SetValue(SepratorColorProperty, value); }
