...
namespace Mohammad.Wpf.Windows.Controls
{
	...
	public partial class CalloutTextBox : IFlickable, IBindable
	{
		...
		public bool IsReaOnly { get => (bool) this.GetValue(IsReaOnlyProperty); set => this.SetValue(IsReaOnlyProperty, value); }
		...
		public bool IsValid { get => (bool) this.GetValue(IsValidProperty); set => this.SetValue(IsValidProperty, value); }
		...
		protected virtual void OnIsReadOnlyChanged(object sender) { this.IsReadOnlyChanged?.Invoke(sender, EventArgs.Empty); }
