...
namespace Mohammad.Wpf.Windows.Output
{
    public class Toast
    {
        ...
        {
            get => this._Parent ?? (this._Parent = Application.Current.MainWindow);
        ...
        public static async void Show(Toast toast, string title, string message, string badge, bool autoHide, TimeSpan timeout, Brush background, Brush forground)
        {
            ...
            try
            {
                ...
                await Task.Delay(timeout != default ? timeout : DefualtTimeout);
            }
        ...
        public static Toast Show(FrameworkElement parent = null,
            string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
            ...
            Brush forground = null,
            ToastScale scale = ToastScale.Default)
        {
        ...
        public static Toast Inform(string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
            TimeSpan timeout = default,
        ...
        public static Toast Warn(string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
            TimeSpan timeout = default,
        ...
        public static Toast Error(string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
            TimeSpan timeout = default,
        ...
        public static void Warn(Toast toast,
            string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
        ...
        public static void Error(Toast toast,
            string title = null,
            string message = null,
            string badge = null,
            bool autoHide = true,
