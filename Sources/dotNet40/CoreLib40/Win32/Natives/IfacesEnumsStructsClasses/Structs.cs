...
namespace Library40.Win32.Natives.IfacesEnumsStructsClasses
{
	...
	public sealed class WindowsHookUtil
	{
		...
		#region Nested type: CBT_CREATEWND
		[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
	...
	public struct RECT : IEquatable<RECT>
	{
		...
		public Size Size
		{
			...
			set
			{
				this._Right = value.Height + this._Left;
		...
		{
			return rectangle._Left == this._Left && rectangle._Top == this._Top && rectangle._Right == this._Right && rectangle._Bottom == this._Bottom;
		}
		...
		public override int GetHashCode()
		{
			unchecked
			{
				...
				result = (result * 397) ^ this._Top;
				result = (result * 397) ^ this._Right;
				result = (result * 397) ^ this._Bottom;
				return result;
			}
		}
	}
