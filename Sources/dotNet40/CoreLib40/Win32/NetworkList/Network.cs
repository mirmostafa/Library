...
namespace Library40.Win32.NetworkList
{
	...
	public class Network
	{
		...
		{
			get { return this.network.GetCategory(); }
		...
		{
			get { return new NetworkConnectionCollection(this.network.GetNetworkConnections()); }
		}
		...
		{
			get { return this.network.GetConnectivity(); }
		}
		...
		{
			get { return this.network.GetDescription(); }
		...
		{
			get { return this.network.GetDomainType(); }
		}
		...
		{
			get { return this.network.IsConnected; }
		}
		...
		{
			get { return this.network.IsConnectedToInternet; }
		}
		...
		public string Name
		{
			get { return this.network.GetName(); }
		...
		{
			get { return this.network.GetNetworkId(); }
		}
	}
}