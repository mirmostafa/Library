...
namespace Library40.DynamicProxy
{
	...
	public class ProxyFactory : Singleton<ProxyFactory>
	{
		...
		static ProxyFactory()
		{
			_OpCodeTypeMapper.Add(typeof (Boolean), OpCodes.Ldind_I1);
			_OpCodeTypeMapper.Add(typeof (Int16), OpCodes.Ldind_I2);
			_OpCodeTypeMapper.Add(typeof (Int32), OpCodes.Ldind_I4);
			_OpCodeTypeMapper.Add(typeof (Int64), OpCodes.Ldind_I8);
			_OpCodeTypeMapper.Add(typeof (Double), OpCodes.Ldind_R8);
			_OpCodeTypeMapper.Add(typeof (Single), OpCodes.Ldind_R4);
			_OpCodeTypeMapper.Add(typeof (UInt16), OpCodes.Ldind_U2);
			_OpCodeTypeMapper.Add(typeof (UInt32), OpCodes.Ldind_U4);
		}
		...
		{
			return this.Create(handler, objType, false);
		}
		...
		private Type CreateType(IProxyInvocationHandler handler, Type[] interfaces, string dynamicTypeName)
		{
			...
			if (handler != null && interfaces != null)
			{
				...
				var delegateConstructor = typeBuilder.DefineConstructor(MethodAttributes.Public,
			...
			if (interfaceMethods != null)
				for (var i = 0; i < interfaceMethods.Length; i++)
				{
					...
					methodIl.Emit(OpCodes.Call,
						typeof (MetaDataFactory).GetMethod("GetMethod",
							new[]
							{
