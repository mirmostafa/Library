		...
		protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
		{
			if (e.ToolStrip is StatusStrip)
			{
				...
				if ((backRectangle.Width > 0) && (backRectangle.Height > 0))
					using (
						var backBrush = new LinearGradientBrush(backRectangle, this.ColorTable.StatusStripGradientBegin, this.ColorTable.StatusStripGradientEnd, LinearGradientMode.Vertical))
					{
