...
namespace Mohammad.Helpers
{
    ...
    public static partial class EnumerableHelper
    {
        ...
        public static IEnumerable<TResult> Zip<TResult, T1, T2>(IEnumerable<T1> source1, IEnumerable<T2> source2,
            Func<T1, T2, TResult> zipper) => source1.SelectMany(item1 => source2, zipper);
        ...
        public static void RemoveRange<TEntity>(this ICollection<TEntity> source, Predicate<TEntity> match) => RemoveRange(source, source.Where(entity => match(entity)));
        ...
        public static void RemoveRange<TEntity>(this IList<TEntity> source, Predicate<TEntity> match) => RemoveRange(source, source.Where(entity => match(entity)));
