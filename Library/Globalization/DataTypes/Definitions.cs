...
namespace Library.Globalization.DataTypes
{
    ...
    internal struct PersianDateTimeData
    {
        ...
        /// </summary>
        /// <value>
        ///     <c>true</c> if this instance has date; otherwise, <c>false</c>.
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///     <c>true</c> if this instance has time; otherwise, <c>false</c>.
        /// </value>
    ...
    public sealed class NumericFormatInfo
    {
        ...
        {
            if (numericFormatInfo == null)
            {
                throw new ArgumentNullException(nameof(numericFormatInfo));
            }
