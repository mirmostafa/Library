...
namespace Library.Globalization
{
    public static class PersianTools
    {
        ...
        /// <returns> </returns>
        public static (int Year, int Month, int Day) GetPersianDateParts(in DateTime date) => (GetPersianYear(date), GetPersianMonth(date), GetPersianDayOfMonth(date));
        ...
        /// <returns> </returns>
        public static int GetPersianDayOfMonth(this DateTime dateTime) => _persianCalendar.GetDayOfMonth(dateTime);
        ...
        /// <param name="month"> The month. </param>
        /// <returns> </returns>
        public static int GetPersianDaysCountInMonth(in int year, in int month) => _persianCalendar.GetDaysInMonth(year, month);
        ...
        /// <param name="dateTime"> The date time. </param>
        /// <returns> </returns>
        public static int GetPersianMonth(this DateTime dateTime) => _persianCalendar.GetMonth(dateTime);
        ...
        /// <param name="dateTime"> The date time. </param>
        /// <returns> </returns>
        public static int GetPersianYear(this DateTime dateTime) => _persianCalendar.GetYear(dateTime);
        ...
        /// <returns> </returns>
        public static PersianDayOfWeek ToPersianDayOfWeek(this DayOfWeek dow) => (PersianDayOfWeek)dow;
        ...
        public static string PersianDateToPersianString(int? year,
            ...
            in Language language = Language.Persian) => Reformat(year, month, day, hour, minute, second, format, language);
        ...
        private static string Reformat(int? year, int? month, int? day, int? hour, int? minute, int? second, string format, Language language)
        {
            ...
            Check.IfNotValid(language, l => !Enum.IsDefined(typeof(Language), language), () => new ArgumentOutOfRangeException(nameof(language)));
