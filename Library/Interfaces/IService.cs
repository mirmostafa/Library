namespace Library.Services
{
    ...
    public interface IReadAsyncPagingService<TViewModel> : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<PagingResult<TViewModel>> GetAllAsync(Paging paging);
    ...
    public record Paging(int PageIndex = 0, int? PageSize = null);
    public record PagingResult<T>(IReadOnlyList<T> Result, Paging? Paging, long TotalCount);
}
