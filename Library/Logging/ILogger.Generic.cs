namespace Library.Logging
{
    public interface ILogger<TLogMessage>
    {
        ...
        /// The empty logger
        /// </summary>
        static readonly ILogger<TLogMessage> Empty = new EmptyLogger<TLogMessage>();
        ...
        void Log(TLogMessage message, LogLevel level = LogLevel.Info, object? sender = null, DateTime? time = null, string? stackTrace = null);
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="time">The time.</param>
        void Info(TLogMessage message, object? sender = null, DateTime? time = null)
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="time">The time.</param>
        void Warn(TLogMessage message, object? sender = null, DateTime? time = null)
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="time">The time.</param>
        void Error(TLogMessage message, object? sender = null, DateTime? time = null)
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="time">The time.</param>
        void Fatal(TLogMessage message, object? sender = null, DateTime? time = null)
        ...
        /// <param name="sender">The sender.</param>
        /// <param name="time">The time.</param>
        void Debug(TLogMessage message, object? sender = null, DateTime? time = null)
        ...
        /// <param name="time">The time.</param>
        /// <param name="stackTrace">The stack trace.</param>
        void Trace(TLogMessage message, object? sender = null, DateTime? time = null, string? stackTrace = null)
