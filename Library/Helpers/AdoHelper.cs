...
public static partial class AdoHelper
{
    ...
    {
        Check.IfArgumentNotNull(table, nameof(table));
    ...
    {
        Check.IfArgumentNotNull(connection, nameof(connection));
        Check.IfArgumentNotNull(execute, nameof(execute));
        Check.IfArgumentNotNull(sql, nameof(sql));
        ...
        Action<SqlParameterCollection>? fillParams = null)
    {
        ...
        Check.IfArgumentNotNull(executeAsync, nameof(executeAsync));
    ...
    {
        Check.IfArgumentNotNull(connection, nameof(connection));
        Check.IfArgumentNotNull(executionBlock, nameof(executionBlock));
    ...
    public static T Field<T>(this IDataReader reader, string columnName, Converter<object, T> converter)
    {
        ...
        Check.IfArgumentNotNull(reader, nameof(reader));
    ...
    public static bool IsNullOrEmpty<T>(this DataRow row, string columnTitle)
        => row is null
        ? throw new ArgumentNullException(nameof(row))
        : row.IsNullOrEmpty(columnTitle) || row[columnTitle].Equals(default(T));
