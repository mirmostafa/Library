...
{
    public static DayOfWeek ToDayOfWeek(this PersianDayOfWeek dow) => dow switch
    {
    ...
    public static PersianDayOfWeek ToPersianDayOfWeek(this DayOfWeek dow) => dow switch
    {
