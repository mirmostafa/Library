...
namespace Library.Helpers.CodeGen
{
    ...
    public static class CodeDomExtension
    {
        ...
        public static CodeNamespace UseNameSpace(this CodeNamespace ns, in string nameSpace)
        {
            ...
            {
                ns.ArgumentNotNull().Imports.Add(new CodeNamespaceImport(nameSpace));
            }
        ...
        {
            interfaces?.ToList().ForEach(codeTypeDeclaration.ArgumentNotNull().BaseTypes.Add);
        ...
        public static CodeTypeDeclaration AddField(this CodeTypeDeclaration c, in Library.CodeGeneration.Models.FieldInfo fieldInfo)
        {
            if (c is null)
            {
        ...
        public static CodeMemberField NewField(Library.CodeGeneration.Models.FieldInfo fieldInfo)
        {
            var fieldName = ToFieldName(fieldInfo.Name.ArgumentNotNull());
        ...
        /// <returns></returns>
        public static CodeTypeDeclaration AddProperty(this CodeTypeDeclaration c, in Library.CodeGeneration.Models.PropertyInfo propertyInfo)
        {
            ...
            var inednt = new string(' ', indentSize);
            ...
            if (propertyInfo.Attributes?.Any() is true)
            {
                ...
                {
                    attrStatements = $"{new string(' ', indentSize)}[{attribute}]{Environment.NewLine}{attrStatements}";
                }
        ...
        public static string RemoveAutoGeneratedTag(in string codeStatement)
            => codeStatement.ArgumentNotNull().Remove(@"//------------------------------------------------------------------------------
// <auto-generated>
