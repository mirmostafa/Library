...
{
    public static void IfArgumentBiggerThan(in int arg, in int min, [DisallowNull] in string argName)
    {
    ...
    [return: NotNull]
    public static string ArgumentNotNull([NotNull] this string obj, [DisallowNull] string argName)
        => obj.NotValid(x => x.IsNullOrEmpty(), () => new ArgumentNullException(argName));

    [return: NotNull]
    public static T ArgumentNotNull<T>([NotNull] this T obj, [DisallowNull] string argName)
        => obj.NotValid(x => x is null, () => new ArgumentNullException(argName));

    public static void IfIs<T>([NotNull] this object obj, [DisallowNull] string argName)
    ...
    public static T ArgumentOutOfRange<T>(this T obj, Func<T, bool> validate, [DisallowNull] string argName)
    ...
    public static void IfArgumentNotNull([NotNull] this string obj, [DisallowNull] string argName)
        => _ = obj.NotValid(x => x is null, () => new ArgumentNullException(argName));

    public static void IfArgumentNotNull<T>([NotNull] this string obj, [DisallowNull] string argName = null)
    ...
    public static void IfArgumentNotNull<T>([NotNull] this T obj, [DisallowNull] string argName)
        //=> _ = obj.NotValid(x => x is null, () => new ArgumentNullException(argName));
