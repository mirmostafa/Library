...
public static class MsLoggerMessageHelper
{
    ...
    public static void Debug(this IMsLogger logger, string log)
        => _debug(logger, log, null);

    public static void Error(this IMsLogger logger, string log, Exception? exception = null)
