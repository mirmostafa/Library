...
public static class LibLogger
{
    ...
    public static void AddConsole(string? format = null)
        => AddLogger(new TextWriterLogger(Console.Out).SetDefaultFormat(format));

    public static void AddLogger(ILogger value)
        => Loggers.Add(value);

    public static void AddLogger(IMsLogger logger)
