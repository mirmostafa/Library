...
//public sealed class Result(in bool? succeed = null,
...
//    : ICloneable
//{
//    public IEnumerable<(object Id, object Error)>? Errors { get; } = errors;
//    public ImmutableDictionary<string, object>? ExtraData { get; } = extraData;
...
//        => new(this.Value, this.Succeed, this.Status, this.Message, errors, this.ExtraData);
...
//        => new(value, this.Succeed, this.Status, this.Message, this.Errors, this.ExtraData);
//}