    ...
    where TSelf : IAdditionOperators<TSelf, TOther, TResult>
{
    ...
    /// The sum of <paramref name="left"/> and <paramref name="right"/> is not representable by
    ...
    where TSelf : ISubtractionOperators<TSelf, TOther, TResult>
{
    ...
    /// <returns>The difference of <paramref name="right"/> subtracted from <paramref name="left"/>.</returns>
    /// <exception cref="OverflowException">
    /// The difference of <paramref name="right"/> subtracted from <paramref name="left"/> is not
    /// representable by <typeparamref name="TResult"/>.
    /// </exception>
    static virtual TResult operator checked -(TSelf left, TOther right) => left - right;
}
