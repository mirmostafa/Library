...
public static class WcfHelper
{
    ...
    public static BasicHttpBinding BasicHttpBinding => new() { Security = { Mode = BasicHttpSecurityMode.None } };

    /// <summary>
    ///     Gets the ws HTTP binding.
    /// </summary>
    /// <value>The ws HTTP binding.</value>
    public static WSHttpBinding WsHttpBinding => new() { Security = { Mode = SecurityMode.None } };
    ...
    public static string CreateUri<TContract>(string? host = null, string? urlSufix = null)
    {
        ...
        {
            throw new Library.Exceptions.ObjectNotFoundException("ServiceConfigAttribute not found.");
        }
    ...
    public static async Task<TContract> GetServiceChannelAsync<TContract>(string? host = null, string? urlSufix = null)
        => await Task.Run(() => GetServiceChannel<TContract>(host, urlSufix));
